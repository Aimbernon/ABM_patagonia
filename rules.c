...
/** \fn int FLAME_filter_indv_dividir_info_13_14_warningDivide(const void *msg, const void *params)
 * \brief The filter function for a message input used in serial for each agent.
 * \param msg The pointer to the message to be filtered.
 * \param params The pointer to the agent memory.
 * \return The success (1) or failure (0) of the filter on the message.
...
{
	//printf("**** FLAME_filter_indv_dividir_info_13_14_warningDivide(const void *msg, const void *params)\n");
...
/** \fn int FLAME_filter_indv_dividir_transfer_14_end_transfer(const void *msg, const void *params)
 * \brief The filter function for a message input used in serial for each agent.
 * \param msg The pointer to the message to be filtered.
 * \param params The pointer to the agent memory.
 * \return The success (1) or failure (0) of the filter on the message.
...
{
	//printf("**** FLAME_filter_indv_dividir_transfer_14_end_transfer(const void *msg, const void *params)\n");
	
	/* Cast the message pointer to the correct message type */
	m_transfer *m = (m_transfer*)msg;
	/* Cast the params pointer to the correct agent type */
	xmachine_memory_indv *a = (xmachine_memory_indv *)params;

	/* The filter */
	if(((a->cID == m->clanID) && (a->indvID == m->indvID))) return 1;
	else return 0;
}
